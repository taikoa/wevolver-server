...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.related_id'
        db.alter_column('activities_activity', 'related_id', self.gf('django.db.models.fields.IntegerField')(max_length=30, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Activity.related_id'
        raise RuntimeError("Cannot reverse this migration. 'Activity.related_id' and its values cannot be restored.")
    ...
    models = {
        'activities.activity': {
            ...
            'related_id': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '30', 'null': 'True'}),
