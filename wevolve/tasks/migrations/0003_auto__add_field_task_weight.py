...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.weight'
        db.add_column(u'task', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.weight'
        db.delete_column(u'task', 'weight')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'projects.projectpart': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
