...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'task', 'title')


        # Changing field 'TaskUser.created'
        db.alter_column(u'task_user', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'TaskSkill.created'
        db.alter_column(u'task_skill', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Adding field 'Task.title'
        db.add_column(u'task', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)


        # Changing field 'TaskUser.created'
        db.alter_column(u'task_user', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 23, 0, 0)))

        # Changing field 'TaskSkill.created'
        db.alter_column(u'task_skill', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 23, 0, 0)))
    ...
    models = {
        ...
        'projects.project': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
