...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'File.created_user'
        db.alter_column(u'file', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Comment.created_user'
        db.alter_column(u'comment', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Post.created_user'
        db.alter_column(u'post', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Document.modified_user'
        db.alter_column(u'document', 'modified_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Document.created_user'
        db.alter_column(u'document', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'File.created_user'
        db.alter_column(u'file', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'Comment.created_user'
        db.alter_column(u'comment', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'Post.created_user'
        db.alter_column(u'post', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'Document.modified_user'
        db.alter_column(u'document', 'modified_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.User']))

        # Changing field 'Document.created_user'
        db.alter_column(u'document', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))
