...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.type_field'
        db.delete_column(u'post', 'type')

        # Deleting field 'Post.data'
        db.delete_column(u'post', 'data')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Post.type_field'
        raise RuntimeError("Cannot reverse this migration. 'Post.type_field' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Post.data'
        raise RuntimeError("Cannot reverse this migration. 'Post.data' and its values cannot be restored.")
