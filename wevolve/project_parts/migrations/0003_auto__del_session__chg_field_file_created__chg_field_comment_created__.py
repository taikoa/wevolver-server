...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'file', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Comment.created'
        db.alter_column(u'comment', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Post.created'
        db.alter_column(u'post', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Document.created'
        db.alter_column(u'document', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'File.created'
        raise RuntimeError("Cannot reverse this migration. 'File.created' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Comment.created'
        raise RuntimeError("Cannot reverse this migration. 'Comment.created' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Post.created'
        raise RuntimeError("Cannot reverse this migration. 'Post.created' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Document.created'
        raise RuntimeError("Cannot reverse this migration. 'Document.created' and its values cannot be restored.")
    ...
    models = {
        ...
        'projects.project': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
