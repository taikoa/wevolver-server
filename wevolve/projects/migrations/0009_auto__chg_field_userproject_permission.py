...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProject.permission'
        db.alter_column(u'user_project', 'permission', self.gf('django.db.models.fields.IntegerField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'UserProject.permission'
        db.alter_column(u'user_project', 'permission', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'projects.project': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'projects.userproject': {
            ...
            'permission': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '2'}),
