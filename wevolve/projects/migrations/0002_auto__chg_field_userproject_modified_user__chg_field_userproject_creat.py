...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProject.modified_user'
        db.alter_column(u'user_project', 'modified_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'UserProject.created_user'
        db.alter_column(u'user_project', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserProject.user'
        db.alter_column(u'user_project', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ProjectPart.modified_user'
        db.alter_column(u'project_part', 'modified_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ProjectPart.created_user'
        db.alter_column(u'project_part', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'UserProject.modified_user'
        db.alter_column(u'user_project', 'modified_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.User']))

        # Changing field 'UserProject.created_user'
        db.alter_column(u'user_project', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'UserProject.user'
        db.alter_column(u'user_project', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'ProjectPart.modified_user'
        db.alter_column(u'project_part', 'modified_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.User']))

        # Changing field 'ProjectPart.created_user'
        db.alter_column(u'project_part', 'created_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))
