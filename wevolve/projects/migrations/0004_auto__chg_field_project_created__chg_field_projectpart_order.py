...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'project', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ProjectPart.order'
        db.alter_column(u'project_part', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.created'
        db.alter_column(u'project', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'ProjectPart.order'
        raise RuntimeError("Cannot reverse this migration. 'ProjectPart.order' and its values cannot be restored.")
    ...
    models = {
        ...
        'projects.project': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
