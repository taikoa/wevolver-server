...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'user_profile', 'twitter',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.facebook'
        db.add_column(u'user_profile', 'facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.linkedin'
        db.add_column(u'user_profile', 'linkedin',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Profile.twitter'
        db.delete_column(u'user_profile', 'twitter')

        # Deleting field 'Profile.facebook'
        db.delete_column(u'user_profile', 'facebook')

        # Deleting field 'Profile.linkedin'
        db.delete_column(u'user_profile', 'linkedin')
    ...
    models = {
        ...
        'users.skill': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 0, 0)', 'null': 'True', 'blank': 'True'}),
