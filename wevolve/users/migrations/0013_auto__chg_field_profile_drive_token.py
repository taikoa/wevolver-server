...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'user_profile', 'drive_token', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.drive_token'
        db.alter_column(u'user_profile', 'drive_token', self.gf('django.db.models.fields.CharField')(max_length=755, null=True))
    ...
    models = {
        ...
        'users.profile': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '255'}),
            'drive_folder': ('django.db.models.fields.CharField', [], {'max_length': '755', 'null': 'True', 'blank': 'True'}),
            'drive_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'drive_token': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'users.skill': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 0, 0)', 'null': 'True', 'blank': 'True'}),
