...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Profile.country' to match new field type.
        db.rename_column(u'user_profile', 'country_id', 'country')
        # Changing field 'Profile.country'
        db.alter_column(u'user_profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'Profile.country' to match new field type.
        db.rename_column(u'user_profile', 'country', 'country_id')
        # Changing field 'Profile.country'
    ...
    models = {
        ...
        'users.skill': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
