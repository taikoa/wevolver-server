...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.picture_name'
        db.alter_column(u'user_profile', 'picture_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.picture_name'
        db.alter_column(u'user_profile', 'picture_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
