...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.drive_id'
        db.alter_column(u'user_profile', 'drive_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.drive_id'
        db.alter_column(u'user_profile', 'drive_id', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'users.skill': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
