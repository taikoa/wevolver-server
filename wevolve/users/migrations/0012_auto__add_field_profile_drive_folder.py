...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'user_profile', 'drive_folder',
                      self.gf('django.db.models.fields.CharField')(max_length=755, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.drive_folder'
        db.delete_column(u'user_profile', 'drive_folder')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'drive_token': ('django.db.models.fields.CharField', [], {'max_length': '755', 'null': 'True', 'blank': 'True'}),
        ...
        'users.skill': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
